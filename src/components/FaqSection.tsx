...
const FaqSection = () => {
  const faqs: FaqItem[] = [
    {
      question: "What is AI automation and how can it benefit my SMB?",
      answer:
        "AI automation uses artificial intelligence to perform tasks that typically require human intelligence. For SMBs, this means streamlining operations, reducing costs, increasing efficiency, and enabling scalability without proportionally increasing overhead.",
    },
    {
      question: "How long does it take to implement your AI solutions?",
      answer:
        "Implementation timelines vary depending on the complexity of your business and the scope of the automation. Typically, our projects range from 2-8 weeks from initial consultation to full implementation, with most SMBs seeing results within the first month.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We work with SMBs across various industries including retail, manufacturing, healthcare, logistics, professional services, and technology. Our solutions are customized to address the specific challenges and opportunities in each industry.",
    },
    {
